...
class QuantEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer("weight_scaling", torch.zeros(1))
        self.epsilon = 1e-12
    ...
    def forward(self, x, positions = None, incremental_state = None):
        ...
        self.weight_scaling = n / ( self.clipping_point - self.pruning_point)
        ...
        return embed_quantize, self.weight_scaling, self.pruning_point
    ...
    def quantize_reset_parameter(self):
        ...
        self.clipping_point.data = torch.Tensor([w_abs.max()]).to(self.weight.device).data
